...
export default function ProviderCard({ provider, categoryId, handleSelectProvider, language,darkMode, themeColors }) {
    return (
        ...
        >
            <div className='flex items-center w-full gap-4' onClick={() =>  handleSelectProvider(provider) }>
