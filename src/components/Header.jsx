      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <button onClick={toggleDarkMode} className={`p-2 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 ${darkMode ? 'bg-slate-700 hover:bg-slate-600 focus:ring-teal-400 focus:ring-offset-slate-800' : 'bg-teal-500 hover:bg-teal-400 focus:ring-white focus:ring-offset-teal-600'}`}>
